...
-- to open a help file in a full window
...
require'lspconfig'.omnisharp_mono.setup {
    ...
    cmd = { vim.fn.stdpath("data") .. "mason/packages/omnisharp-mono/omnisharp-mono", "--languageserver", "--hostPID", tostring(vim.fn.getpid()) },
